...
namespace InputManager
{
    ...
    static class Controller
    {
        ...
        private static bool ControllerPortValid(int controllerPort)
        {
        ...
        public static float MainHorizontal(int controllerPort = 1)
        {
        ...
        public static float MainVertical(int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return 0; }
        ...
        public static Vector3 MainAxes(int controllerPort = 1, float diagonalLimitDivition = 1.5f)
        {
        ...
        public static bool MainAxesIsActive(int controllerPort = 1)
        {
        ...
        public static float SecondHorizontal(int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return 0; }
        ...
        public static float SecondVertical(int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return 0; }
        ...
        public static Vector3 SecondAxes(int controllerPort = 1, float diagonalLimitDivition = 1.5f)
        {
            if (!ControllerPortValid(controllerPort)) { return Vector3.zero; }
        ...
        public static bool SecondAxesIsActive(int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        public static float DpadHorizontal(int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return 0; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>returns float depending on Dpad horizontal</returns>
        public static float DpadVertical(int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return 0; }
        ...
        public static bool Action0(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>return bool value dependent on button press</returns>
        public static bool Action1(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>return bool value dependent on button press</returns>
        public static bool Action2(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>return bool value dependent on button press</returns>
        public static bool Action3(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>return bool value dependent on button press</returns>
        public static bool Action4(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>return bool value dependent on button press</returns>
        public static bool Action5(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>return bool value dependent on button press</returns>
        public static bool Action6(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>return bool value dependent on button press</returns>
        public static bool Action7(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>return bool value dependent on button press</returns>
        public static bool Action8(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>return bool value dependent on button press</returns>
        public static bool Action9(Button button, int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        public static bool LeftTrigger(int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        /// <param name="controllerPort"></param>
        /// <returns>returns true if value on trigger is not 0</returns>
        public static bool RightTrigger(int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return false; }
        ...
        public static float Triggers(int controllerPort = 1)
        {
            if (!ControllerPortValid(controllerPort)) { return 0; }
